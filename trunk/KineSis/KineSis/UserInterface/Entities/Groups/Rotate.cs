    ...
    class Rotate : Group {
        ...
        void Group.Draw(Canvas c) {
            if (UIManager.SecondHand != null && UIManager.FirstHandNumber != 0 && UIManager.FirstHand.IsSelected) {
                ...
                double leftAreaX = initialX - 200;
                double leftAreaY = initialY;

                double rightAreaX = initialX + 200;
                ...
                double downAreaY = initialY + 200;

                if (UIManager.FirstHand.X > rightAreaX - 75 && UIManager.FirstHand.X < rightAreaX + 75 && UIManager.FirstHand.Y > rightAreaY - 75 && UIManager.FirstHand.Y < rightAreaY + 75 && !selected) {
                    selected = true;
                    rightSelected = true;
                    UIManager.RotateRight();
                } else if (UIManager.FirstHand.X > leftAreaX - 75 && UIManager.FirstHand.X < leftAreaX + 75 && UIManager.FirstHand.Y > leftAreaY - 75 && UIManager.FirstHand.Y < leftAreaY + 75 && !selected) {
                    selected = true;
                    leftSelected = true;
                    UIManager.RotateLeft();
                } else if (UIManager.FirstHand.X > upAreaX - 75 && UIManager.FirstHand.X < upAreaX + 75 && UIManager.FirstHand.Y > upAreaY - 75 && UIManager.FirstHand.Y < upAreaY + 75 && !selected) {
                    selected = true;
                    upSelected = true;
                    UIManager.RotateUp();
                } else if (UIManager.FirstHand.X > downAreaX - 75 && UIManager.FirstHand.X < downAreaX + 75 && UIManager.FirstHand.Y > downAreaY - 75 && UIManager.FirstHand.Y < downAreaY + 75 && !selected) {
                    selected = true;
                    downSelected = true;
